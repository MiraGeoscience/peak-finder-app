...
def test_version_is_consistent():
    project_version = Version(peak_finder.__version__)
...
def _version_module_exists():
    try:
        importlib.import_module("peak_finder._version")
        return True
...
@pytest.mark.skipif(
    ...
    reason="peak_finder._version can be found: package is built",
)
...
@pytest.mark.skipif(
    ...
    reason="peak_finder._version cannot be found: uses a fallback version",
)
